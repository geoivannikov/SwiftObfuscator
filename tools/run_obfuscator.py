...
def compare_results():
    test_cases = [
        ...
        ("typealiases", "SwiftSamples/typealiases", "SwiftSamplesResultTmp/typealiases", "SwiftSamplesResult/typealiases")
    ]
...
def run_all_obfuscations():
    test_cases = [
        ...
        ("typealiases", "SwiftSamples/typealiases", "SwiftSamplesResultTmp/typealiases")
    ]
